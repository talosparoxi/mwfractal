...
NEM_Black_to_White::NEM_Black_to_White( boost::shared_ptr<ProgramOptions> opts )
 : Colourizer::Colourizer( opts ) {
}

NEM_Black_to_White::NEM_Black_to_White( const NEM_Black_to_White& orig )
 : Colourizer::Colourizer( orig ) {
}

NEM_Black_to_White::~NEM_Black_to_White() {
}
